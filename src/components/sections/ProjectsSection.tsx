...
const projects: Project[] = [
  {
    ...
    video2Url: '/videos/fortis-seneca/fortis-video-4.mp4',
    ...
    video4Url: '/videos/fortis-seneca/fortis-video-2.mp4',
      ...
      >
        ...
        <div className="flex flex-row items-center justify-between gap-2 border-b border-[#E6DCCC] pb-2 flex-wrap">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {/* Clean KPI Win Badge */}
            <span className="text-xs sm:text-sm font-mono px-3.5 py-1.5 rounded-full bg-[#3D2E2B] text-[#FAF6EE] shadow-md font-bold flex items-center gap-1.5">
              <TrendingUp className="w-4 h-4 text-[#FAF6EE]/90" /> {project.kpiMetric}
            </span>
          </div>

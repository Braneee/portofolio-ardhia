...
export function ProjectGallerySection() {
  ...
  return (
    <section id="project-gallery" className="w-full bg-[#FAF4EA] text-[#3D2E2B] py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-10 font-sans border-b border-[#E6DCCC]">
      <div className="max-w-7xl mx-auto">
        
        {/* Header section */}
        <FadeIn>
          <div className="flex flex-col items-center text-center mb-12">
            <h2 className="hero-heading font-black uppercase text-[clamp(2.3rem,8vw,120px)] leading-none tracking-tight mb-6">
              Project Gallery
            </h2>

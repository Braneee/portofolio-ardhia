    ...
    <section id="experience" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-10 bg-[#F9F6F0] text-[#3D2E2B] relative z-10 w-full border-b border-[#E6DCCC] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16 relative z-10">
        ...
        <div className="relative w-full z-0">
          ...
          {/* Vertical Line */}
          <div className="absolute bottom-0 left-4 md:left-1/2 -translate-x-1/2 w-1  shadow-[0_0_15px_rgba(232,139,115,0.3)] z-0" style={{ top: "-500px", background: "linear-gradient(to bottom, #E88B73 0%, #E88B73 15%, #C4A468 40%, #6B8065 100%)" }} />

...
export function ExperienceSection() {
  return (
    <section id="experience" className="py-20 sm:py-24 md:py-32 px-4 sm:px-6 md:px-10 bg-gradient-to-b from-[#F9F6F0] via-[#FAF4EA] to-[#F5F0E6] text-[#3D2E2B] relative z-10 w-full border-b border-[#E6DCCC] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto space-y-16 relative z-10">
        ...
        <div className="relative w-full">
          ...
          <div className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-1 bg-gradient-to-b from-[#E88B73] via-[#C4A468] to-[#6B8065] shadow-[0_0_15px_rgba(232,139,115,0.3)] z-0 rounded-full" />
          ...
          <div className="space-y-12 sm:space-y-16 relative z-10">
              ...
              return (
                <FadeIn key={exp.id} delay={idx * 0.15} y={30}>
                  <div className="relative flex items-center justify-between w-full min-h-[140px]">
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center w-11 h-11 rounded-full border-2 border-[#E88B73] bg-[#FAF6EE] text-[#E88B73] shadow-lg z-30 transition-transform duration-300 hover:scale-125">
                      <span className="w-3.5 h-3.5 rounded-full bg-[#E88B73] animate-pulse" />
                    </div>
                    ...
                    <div className="w-full md:w-[calc(50%-2.5rem)] ml-auto md:ml-0">
                      {isRight ? (
                        ...
                        <div className="block md:hidden p-6 sm:p-8 rounded-[30px] bg-[#FFFFFF] border border-[#E6DCCC] shadow-xl space-y-4">
                          <div className="space-y-1">
                            <div className="flex items-center justify-between gap-2 flex-wrap">
                              <span className="text-xs font-mono px-3 py-1 rounded-full bg-[#F5EBE6] text-[#E88B73] border border-[#F4A28C]/40 flex items-center gap-1.5 font-semibold">
                                <Calendar className="w-3 h-3 text-[#E88B73]" /> {exp.period}
            ...
            <FadeIn delay={0.45} y={30}>
              <div className="relative flex items-center justify-between w-full min-h-[140px]">
                ...
                {/* DEAD CENTER NODE DOT */}
                <div className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center w-11 h-11 rounded-full border-2 border-[#6B8065] bg-[#FAF6EE] text-[#6B8065] shadow-lg z-30 transition-transform duration-300 hover:scale-125">
                  <GraduationCap className="w-5 h-5 text-[#6B8065]" />
                </div>

                {/* RIGHT SLOT */}
                <div className="w-full md:w-[calc(50%-2.5rem)] ml-auto md:ml-0">
                  <div className="block md:hidden p-6 sm:p-8 rounded-[30px] bg-[#FFFFFF] border border-[#E6DCCC] shadow-xl space-y-3">
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <span className="text-xs font-mono px-3 py-1 rounded-full bg-[#EBF0EA] text-[#6B8065] border border-[#A8BBA2]/40 flex items-center gap-1 font-semibold">
                        2019 &ndash; 2023
                      </span>
